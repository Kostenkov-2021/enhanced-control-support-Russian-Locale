# Enhanced Control Support (Расширенная поддержка элементов управления).
* Автор: Emil-18.
...
* Когда выбрана расширенная UIA и появляется выделенное предложение, на него будет перемещён не фокус, а  объект навигатора.
